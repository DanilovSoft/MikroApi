...
internal class DynamicReflectionDelegateFactory
{
    ...
    {
        var dynamicMethod = CreateDynamicMethod("", returnType: typeof(void), parameterTypes: new[] { typeof(object), typeof(object) }, owner: method.DeclaringType!);
        var generator = dynamicMethod.GetILGenerator();
    ...
    {
        var dynamicMethod = CreateDynamicMethod("", returnType: typeof(void), parameterTypes: new[] { typeof(object), typeof(object) }, owner: type);
        var generator = dynamicMethod.GetILGenerator();
